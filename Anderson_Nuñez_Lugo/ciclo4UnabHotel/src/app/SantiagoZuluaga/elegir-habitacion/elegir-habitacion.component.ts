...
declare var sencilla: any;
declare var doble: any;
declare var triple: any;
declare var king: any;
@Component({
  selector: 'app-elegir-habitacion',
  templateUrl: './elegir-habitacion.component.html',
  styleUrls: ['./elegir-habitacion.component.css']
})
export class ElegirHabitacionComponent implements OnInit {
  week: any = [
    "LUNES",
    "MARTES",
    "MIERCOLES",
